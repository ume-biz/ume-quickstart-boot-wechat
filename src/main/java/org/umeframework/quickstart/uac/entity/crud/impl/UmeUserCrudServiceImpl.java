...
public class UmeUserCrudServiceImpl extends BaseDBComponent implements UmeUserCrudService {
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#updateFully
     */
    @Override
    @TransactionRequired
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#updateFullyList
     */
    @Override
    @TransactionRequired
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#findListMatch
     */
    @Override
    public List<UmeUserDto> findListMatch(Map<String, String> dynaCondition) {
        return super.getDao().queryForObjectList(UmeUserDto.SQLID.FIND_LIST_MATCH, dynaCondition, UmeUserDto.class);
    }
