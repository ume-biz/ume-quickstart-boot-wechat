...
import org.umeframework.quickstart.uac.entity.UmeWechatUserDto;
import org.umeframework.quickstart.uac.user.impl.BaseAuthenticator;
 ...
 * @author mayue
 */
public class WechatUserCodeAuthenticatorImpl extends BaseAuthenticator<Map<String, Object>> implements org.umeframework.quickstart.uac.message.MessageConst {
	/**
	 * 微信通用服务接口实例。
	 */
	 ...
	 */
	@Override
	public Map<String, Object> findBizUser(String accessCode, String optionPasspord, String... options) {
